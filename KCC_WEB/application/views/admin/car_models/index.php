                ...
                <div class="grid-body no-border">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="/admin/car_models/add" class="btn btn-primary tip" data-toggle="tooltip" title="Create"><i class="fa fa-plus"></i></a>
                        </div>
                       ...
                       <table class="table table-bordered table-hover">
                        <thead>
                             <tr>
                                ...
                                <th style="width:30%">Manufacturers Code</th>
                        ...
                        <?php foreach ($models as $model) : ?>
                            <tr>
                                <td>
                                     <div class="checkbox check-default">
                                        <input name="checkall" id="checkbox<?php echo $model->id; ?>" type="checkbox" value="<?php echo $model->id; ?>">
                                        <label for="checkbox<?php echo $model->id; ?>"></label>
                                    </div>
                                </td>
                                <td><?php echo $model->model_code; ?></td>
                                <td><?php echo $model->manufacturer_code; ?></td>
                               
                                <td>
                                    <?php if ($model->status == 'DEACTIVE'): ?>
                                        <a href="/admin/car_models/status/<?php echo $model->id; ?>" class="singleStatus"><span class="label label-important">Deactive</span></a>
                                    <?php else: ?>
                                        <a href="/admin/car_models/status/<?php echo $model->id; ?>" class="singleStatus"><span class="label label-info">Active</span></a>
                                    <?php endif ?>
                                 </td>
                                <td>
                                    <a href="/admin/car_models/edit/<?php echo $model->id; ?>" class="label label-info"> <i class="fa fa-edit"></i></a>
                                    <a href="/admin/car_models/delete/<?php echo $model->id;?>" class="label label-important singleDelete"> <i class="fa fa-trash-o"></i></a>    
                                </td>
                            </tr>
                            <?php endforeach ?>
                        </tbody>
    ...
    $(document).ready(function() {
        ...
        $("#activeAll").on('click', function(e) {
           ...
           var checkall = [];
            ...
            $.ajax({
                url: '/admin/car_models/activeall',
                type: 'get',
                dataType: 'json',
        ...
        $("#deactiveAll").on('click', function(e) {
           ...
           var checkall = [];
            ...
            $.ajax({
                url: '/admin/car_models/deactiveall',
                type: 'get',
                dataType: 'json',
                data: { checkall: checkall},
                success: function(response){
