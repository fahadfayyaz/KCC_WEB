                ...
                <div class="grid-body no-border">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <a href="/admin/car_manufacturers/add" class="btn btn-primary tip" data-toggle="tooltip" title="Create"><i class="fa fa-plus"></i></a>
                        </div>
                    ...
                    <br>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                     <div class="checkbox check-default">
                                        <input name="checkall" id="checkbox<?php echo $manufacturer->id; ?>" type="checkbox" value="<?php echo $manufacturer->id; ?>">
                                        <label for="checkbox<?php echo $manufacturer->id; ?>"></label>
                                    </div>
                                </td>
                                <td><?php echo $manufacturer->manufacturer_name; ?></td>
                                <td><?php echo $manufacturer->manufacturer_Details; ?></td>
                               
                                <td>
                                    <?php if ($manufacturer->status == 'DEACTIVE'): ?>
                                        <a href="/admin/car_manufacturers/status/<?php echo $manufacturer->id; ?>"class="singleStatus"><span class="label label-important">Deactive</span></a>
                                    <?php else: ?>
                                        <a href="/admin/car_manufacturers/status/<?php echo $manufacturer->id; ?>" class="singleStatus"><span class="label label-info">Active</span></a>
                                    <?php endif ?>
                                 </td>
                                <td>
                                    <a href="/admin/car_manufacturers/edit/<?php echo $manufacturer->id; ?>" class="label label-info"> <i class="fa fa-edit"></i></a>
                                    <a href="/admin/car_manufacturers/delete/<?php echo $manufacturer->id;?>" class="label label-important singleDelete"> <i class="fa fa-trash-o"></i></a>    
                                </td>
                            </tr>
                            <?php endforeach ?>
                        </tbody>
    ...
    $(document).ready(function() {
        ...
        $("#activeAll").on('click', function(e) {
           ...
           var checkall = [];
            ...
            $.ajax({
                url: '/admin/car_manufacturers/activeall',
                type: 'get',
                dataType: 'json',
        ...
        $("#deactiveAll").on('click', function(e) {
           ...
           var checkall = [];
            ...
            $.ajax({
                url: '/admin/car_manufacturers/deactiveall',
                type: 'get',
                dataType: 'json',
                data: { checkall: checkall},
                success: function(response){
