                ...
                <div class="col-md-6">
                  <h4>Basic Information</h4>            
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="car_feature_description" id="car_feature_description" type="text"  class="form-control" placeholder="Manufacturer Name" value="<?php echo $feature->car_feature_description; ?>" >
                      </div>
                    </div>
