    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div id="content" class="col-sm-9">
          <h1 class="title">
            <?php if ($this->input->get('asking_price')): ?>
                <?php echo 'Prices: ' . $this->input->get('asking_price') ?>
            <?php endif ?>

            <?php if ($this->input->get('registration_year')): ?>
              <?php echo 'Registration Year: ' . $this->input->get('registration_year') ?>
            <?php endif ?>
              ...
              <div class="product-thumb">
                ...
                <div>
                  <div class="caption">
                    ...
                    <p class="asking_price"> <span class="price-new">Rs/ <?php echo number_format($sale->asking_price); ?> </span></p>
                  </div>
